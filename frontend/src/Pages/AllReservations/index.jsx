import AllResvPropertyCard from '../../Components/AddResvPropertyCard';
...
const AllReservations = () => {
   ...
   const [searchParams, setSearchParams] = useSearchParams();
    ...
    const fetchFilterData = () => {
      fetch('http://127.0.0.1:8000/property/allreservations/?name='+name+"&location="+location+ordering+'&p='+pageNum, {
          method: 'get',
          headers: {
      ...
      <div className="form">
        ...
        <div className="cards">
          {data.map(function(d, idx){
            return (<AllResvPropertyCard key={idx} house = {d}></AllResvPropertyCard>)
          })}
        </div>
        {/* Pagination */}
